/*! ePOS-Print API Version 3.0.0 Copyright (C) SEIKO EPSON CORPORATION 2011. All rights reserved. */
(function(window, undefined) {
    ...
    var regexFont = /^(font_[abc]|special_[ab])$/,
        ...
        regexSymbol = /^(pdf417_(standard|truncated)|qrcode_model_[12]|maxicode_mode_[2-6]|gs1_databar_(stacked(_omnidirectional)?|expanded_stacked)|azteccode_(fullrange|compact)|datamatrix_(square|rectangle_(8|12|16)))$/,
    ...
    ePOSPrint.prototype.send = function(request) {
        ...
        soap = '<?xml version="1.0" encoding="utf-8"?><s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/"><s:Body>' + request + "</s:Body></s:Envelope>";
            ...
            if (!("withCredentials" in xhr) && window.XDomainRequest) {
                ...
                xhr.onload = function() {
                    ...
                    if (/response/.test(res)) {
                        ...
                        if (args > 0) {
                            fireReceiveEvent(epos, success, code, status, battery)
                        } else {
                ...
                xhr.ontimeout = function(){
                	fireTimeoutEvent(epos, 0, "Printer is offline")
                };
                ...
                xhr.onreadystatechange = function() {
                    if (xhr.readyState == 4) {
                        ...
                        if(xhr.status == 0){
                        	fireTimeoutEvent(epos, null, null);
                        }
    ...
    function fireReceiveEvent(epos, success, code, status, battery) {
        if (epos.onreceive) {
            epos.onreceive({
                success: success,
                code: code,
    ...
    function fireTimeoutEvent(epos, status, responseText) {
        if (epos.ontimeout) {
            epos.ontimeout({
                status: status,
                responseText: responseText
    ...
    CanvasPrint.prototype.print = function(canvas) {
        var args = arguments.length,
